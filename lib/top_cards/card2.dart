...
class _Card2State extends State<Card2> {
  ...
  void _savePlace(String placeName, String rating, String image) async {
    ...
    sharedPreference.setStringList("2", [placeName, rating, image]);
  }
          ...
          children: [
                ...
                child: Center(
                  child: IconButton(
                    ...
                    onPressed: () {
                      ...
                      _savePlace('Archeological Museum', '4.3', 'assets/museum.jpeg');
                    },
                  ),
                ),
            ...
            Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Museum', style: GoogleFonts.bellota(fontSize: 20,fontWeight: FontWeight.w900, color: Colors.white)),
                    SizedBox(height: 15,),
                    Row(
                      children: [
